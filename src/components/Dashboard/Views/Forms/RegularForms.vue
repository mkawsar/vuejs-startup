                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4 col-sm-offset-1">
                                    ...
                                    <p-checkbox v-model="checkboxes.disabledUnchecked" :disabled="true">Disabled
                                        unchecked
                                    </p-checkbox>
                                    <p-checkbox v-model="checkboxes.disabledChecked" :disabled="true">Disabled checked
                                    </p-checkbox>
                                </div>
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <p-radio label="1" v-model="radios.radio2" :disabled="true">Disabled radio is off
                                    </p-radio>
                                    <p-radio label="2" v-model="radios.radio2" :disabled="true">Disabled radio is on
                                    </p-radio>
                                </div>
                            </div>
                        </fieldset>
