    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="category">
                ...
                Check out more functionalities at <a href="http://element.eleme.io/#/en-US/component/table"
                                                     target="_blank">Element-UI table documentation</a>.
            </p>
        </div>
            ...
            <div class="card-content row">
                ...
                <div class="col-sm-6">
                    <div class="pull-right">
                        <label>
                            <input type="search" class="form-control input-sm" placeholder="Search records"
                    ...
                    <el-table class="table-striped"
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="props">
                                <a class="btn btn-simple btn-xs btn-info btn-icon like"
